            ...
            <div className='themain'>
             ...
             <div className='peopelask'>
                <div className='askquestions' onClick={openclose}>
                    <span>What services does Amplified Insurance & Security Company provide?</span>
                    <span style={{fontSize: '30px'}}>
                        {openClose ? <GrFormClose />:<MdAddCircleOutline />}
                        </span>
                </div>
                {openClose && (
                <div><p>Amplified Insurance & Security Company offers a wide range of logistics services, including international and domestic shipping, freight forwarding, warehousing, customs clearance, supply chain management, and express delivery.</p></div>
                )}
             </div>
             ...
             <div className='peopelask'>
                ...
                {openCose && (
                <div><p>Amplified Insurance & Security Company has extensive experience in customs clearance procedures. Our team will guide you through the necessary documentation and requirements for smooth customs clearance. We handle the necessary paperwork and ensure compliance with customs regulations to minimize delays.</p></div>
                )}
             </div>
